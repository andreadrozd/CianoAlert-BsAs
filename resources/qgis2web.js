...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8457436.380211, -5857926.787301, -4892324.259682, -3171085.476011], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-8457436.380211, -5857926.787301, -4892324.259682, -3171085.476011], map.getSize());
    ...
    element: (() => {
        ...
        if (374 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Actualizaciones semanas de alertas por cianobacterias<br />Productos satelitales elaborados a partir de imágenes Sentinel-2 y Sentinel-3 donde se estiman indicadores de densidad celular de cianobacterias, pigmentos fotosintéticos como clorofila y ficocianina.<br />Los datos son integrados semanalmente y a partir de los mismos se obentiene el nivel de alerta y la tendencia semanal.<br />';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_AlertaCianobacterias20260422SRH_3,
    colName: 'PUNTO',
    zoom: 10,
    collapsed: true,
    map: map,
